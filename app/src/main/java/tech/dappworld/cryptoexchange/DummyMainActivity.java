...
public class DummyMainActivity extends AppCompatActivity
    ...
    private void proceedToMainActivity() {
        Intent intent = new Intent(DummyMainActivity.this, MainActivity.class);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(DummyMainActivity.this, ExchangeConvertActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.quick_convertMenu) {
            Intent intent = new Intent(DummyMainActivity.this, FastCalculatorNavActivity.class);
            startActivity(intent);
        } else if (id == R.id.quick_aboutMenu) {
            Intent intent = new Intent(DummyMainActivity.this, AboutActivity.class);
            startActivity(intent);
        }else if (id == R.id.homeExchangeRate) {
                Intent intent = new Intent(DummyMainActivity.this, MainActivity.class);
                startActivity(intent);
        }else if (id == R.id.offlineCalculator) {
            Intent intent = new Intent(DummyMainActivity.this, OfflineCalculatorActivity.class);
            startActivity(intent);
        }else if (id == R.id.visit_repo) {
            Intent intent = new Intent(DummyMainActivity.this, RepositoryWebViewActivity.class);
            startActivity(intent);
